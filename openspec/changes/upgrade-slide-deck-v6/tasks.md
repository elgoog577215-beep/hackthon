...
- [ ] 7.7 Restore funded primary/fallback credentials, run one successful measured build and inspect the rendered Web/PPTX result before declaring the Agent quality gate complete.
