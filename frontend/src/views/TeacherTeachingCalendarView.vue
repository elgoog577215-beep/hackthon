...
.home-layout{grid-template-columns:270px minmax(600px,1fr) 300px}
...
@media(max-width:1100px){.home-layout{grid-template-columns:230px minmax(520px,1fr) 270px}.calendar-title span{display:none}}
