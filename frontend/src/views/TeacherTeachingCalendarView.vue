...
.course-rail{grid-template-rows:72px minmax(0,1fr) 48px}.course-rail>header{padding:0 14px 0 16px}.course-rail>header span{line-height:1.4}.course-filter-reset{flex:none}.course-list{padding:5px 7px 10px}.course-entry{margin-bottom:2px}.course-entry.active{color:var(--lz-brand-strong);background:var(--lz-brand-soft);box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--lz-brand) 42%,var(--lz-border))}.course-entry.active .course-icon{color:var(--lz-brand-strong);background:#fff;box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--lz-brand) 30%,var(--lz-border))}.course-entry.active .course-entry__copy strong,.course-entry.active .course-entry__open{color:var(--lz-brand-strong)}
...
.total-week-grid{--week-gridline:#edf0f5;--week-gridline-strong:#dfe4ec;min-width:980px;display:grid;grid-template-columns:82px repeat(7,minmax(128px,1fr));grid-template-rows:50px repeat(13,62px);position:relative;overflow:clip;border:1px solid #e3e7ee;border-radius:14px;background:#fff;box-shadow:0 10px 28px rgb(15 23 42 / 5.5%),0 1px 2px rgb(15 23 42 / 4%);isolation:isolate}
