...
.course-rail{grid-template-rows:72px minmax(0,1fr) 48px}.course-rail>header{padding:0 14px 0 16px}.course-rail>header span{line-height:1.4}.course-filter-reset{flex:none}.course-list{padding:5px 7px 10px}.course-entry{margin-bottom:2px}.course-entry.active{color:var(--lz-brand-strong);background:var(--lz-brand-soft);box-shadow:none}.course-entry.active .course-icon{color:var(--lz-brand-strong);background:transparent}.course-entry.active .course-entry__copy strong,.course-entry.active .course-entry__open{color:var(--lz-brand-strong)}
