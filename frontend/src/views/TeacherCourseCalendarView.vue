        ...
        <section class="calendar-workspace">
          <header class="workspace-toolbar">
            ...
            <span v-if="editable" class="calendar-revision" :class="{ dirty }" role="status">
              {{ dirty ? t('teacherCalendar.unsaved', '未保存') : `r${editable.revision || 0}` }}
            </span>
