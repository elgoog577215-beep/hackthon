...
.library-toolbar { max-width:1280px; margin:24px auto 14px; display:grid; grid-template-columns:minmax(240px,360px) minmax(0,1fr) auto; align-items:center; gap:12px; }
...
.library-resume:hover .library-resume__action svg,.library-resume:focus-visible .library-resume__action svg { transform:translateX(3px); }
