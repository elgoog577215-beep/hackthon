...
.preparation-dialog.is-choice{width:min(960px,calc(100vw - 48px));max-height:min(640px,calc(100dvh - 40px));border:1px solid rgba(165,180,252,.22);background:#11172a;box-shadow:0 34px 90px rgba(15,23,42,.38)}
...
.preparation-choice{position:relative;isolation:isolate;min-height:520px;grid-template-rows:auto minmax(0,1fr);overflow:hidden;background:radial-gradient(circle at 88% -8%,rgba(99,102,241,.4),transparent 36%),radial-gradient(circle at 4% 112%,rgba(139,92,246,.26),transparent 38%),linear-gradient(145deg,#111827 0%,#171934 58%,#101626 100%)}
.preparation-choice::before{position:absolute;inset:0;z-index:-1;background:linear-gradient(116deg,transparent 0 42%,rgba(255,255,255,.035) 42.2% 42.35%,transparent 42.55% 100%);content:"";pointer-events:none}
.preparation-choice>header{position:relative;z-index:1;padding:30px 32px 18px;border-bottom:0}
.preparation-choice>header>span{width:44px;height:44px;border:1px solid rgba(255,255,255,.2);border-radius:13px;color:#fff;background:linear-gradient(135deg,#6366f1,#8b5cf6);box-shadow:0 10px 24px rgba(79,70,229,.32),inset 0 1px 0 rgba(255,255,255,.28)}
.preparation-choice h2{color:#fff;font-size:25px;letter-spacing:-.025em}
.start-options{position:relative;z-index:1;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;padding:14px 32px 34px}
.start-options>button{position:relative;min-width:0;min-height:310px;display:flex;align-items:flex-start;flex-direction:column;overflow:hidden;padding:28px;border:1px solid rgba(199,210,254,.16);border-radius:16px;color:#f8fafc;background:linear-gradient(150deg,#202940 0%,#171d31 100%);text-align:left;cursor:pointer;box-shadow:0 20px 44px rgba(2,6,23,.2);transition:transform .2s cubic-bezier(.16,1,.3,1),border-color .2s ease,box-shadow .2s ease}
.start-options>button::before{position:absolute;top:-86px;right:-66px;width:210px;height:210px;border-radius:50%;background:radial-gradient(circle,rgba(129,140,248,.24),rgba(129,140,248,0) 68%);content:"";pointer-events:none;transition:transform .35s cubic-bezier(.16,1,.3,1),opacity .2s ease}
.start-options>button.existing-course{border-color:rgba(224,231,255,.24);background:linear-gradient(145deg,#5955e7 0%,#4338ca 56%,#312e81 100%);box-shadow:0 22px 48px rgba(49,46,129,.28)}
.start-options>button.existing-course::before{background:radial-gradient(circle,rgba(255,255,255,.22),rgba(255,255,255,0) 68%)}
.start-options>button:hover:not(:disabled){transform:translateY(-4px);border-color:rgba(199,210,254,.55);box-shadow:0 28px 58px rgba(2,6,23,.3)}
.start-options>button:hover:not(:disabled)::before{transform:translate(-8px,10px) scale(1.08);opacity:1}
.start-options>button:active:not(:disabled){transform:translateY(-1px) scale(.995)}
.start-options>button>span{position:relative;width:56px;height:56px;display:grid;place-items:center;flex:none;border:1px solid rgba(255,255,255,.14);border-radius:15px;color:#c7d2fe;background:rgba(255,255,255,.08);box-shadow:inset 0 1px 0 rgba(255,255,255,.12)}
.start-options>button.existing-course>span{color:#fff;background:rgba(255,255,255,.15)}
.start-options strong{position:relative;margin-top:auto;color:#fff;font-size:23px;letter-spacing:-.025em;line-height:1.2}
.start-options small{position:relative;max-width:280px;margin-top:9px;padding-right:48px;color:#cbd5e1;font-size:13px;line-height:1.6}
.start-options>button.existing-course small{color:#e0e7ff}
.start-options>button>svg{position:absolute;right:27px;bottom:28px;width:40px;height:40px;padding:11px;border:1px solid rgba(255,255,255,.16);border-radius:12px;color:#e0e7ff;background:rgba(255,255,255,.08);transition:transform .2s cubic-bezier(.16,1,.3,1),background .2s ease}
.start-options>button:hover:not(:disabled)>svg{transform:translateX(3px);background:rgba(255,255,255,.14)}
.preparation-choice>.dialog-error{position:relative;z-index:2;color:#fecaca;background:rgba(127,29,29,.52)}
