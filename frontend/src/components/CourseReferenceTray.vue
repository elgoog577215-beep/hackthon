<template>
  <aside class="reference-tray" :aria-label="t('courseWorkbench.references.title', '信息来源')">
...
import { Check, CopyPlus, Database, ExternalLink, FileText, Globe2, Plus, Search, X } from 'lucide-vue-next'
