    ...
    <div v-else-if="!review" class="ppt-review-start">
      ...
      <div class="ppt-review-start-actions">
        <button class="ppt-upload-primary" type="button" :disabled="busy" @click="fileInput?.click()">
          ...
          {{ busy ? t('courseWorkbench.pptReview.analyzing', '正在解析与建立索引…') : t('courseWorkbench.pptReview.upload', '上传并审阅 PPT') }}
        </button>
...
import { Check, CheckCircle2, Download, FileSearch, LoaderCircle, Pencil, Presentation, RefreshCw, Sparkles, TriangleAlert, Upload } from 'lucide-vue-next'
...
@media(max-width:1180px){.ppt-review-layout{grid-template-columns:160px minmax(360px,1fr) 280px}.ppt-slide-canvas{padding:40px}.ppt-review-toolbar-actions button{font-size:0}.ppt-review-toolbar-actions button svg{display:block}}
@media(max-width:760px){.ppt-review-start{padding:28px 18px}.ppt-review-start>header{align-items:flex-start}.ppt-review-start-actions{width:100%;flex-direction:column}.ppt-review-start-actions button{width:100%}.ppt-review-toolbar{align-items:flex-start;flex-direction:column;padding:12px}.ppt-review-toolbar-actions{width:100%}.ppt-review-toolbar-actions button{flex:1}.ppt-review-layout{display:block}.ppt-slide-list{display:flex;overflow:auto;border-right:0;border-bottom:1px solid #e5eaf1}.ppt-slide-list button{min-width:150px}.ppt-slide-workarea{padding:14px 12px}.ppt-slide-canvas{min-height:360px;padding:32px 24px}.ppt-review-report{border-top:1px solid #e5eaf1;border-left:0}}
</style>
