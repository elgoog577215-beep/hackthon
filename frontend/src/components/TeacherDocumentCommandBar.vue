...
.teacher-document-command-bar button{min-height:34px;display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:0 9px;border:1px solid transparent;border-radius:9px;color:#526077;background:transparent;font-size:14px;font-weight:750;cursor:pointer}
...
.teacher-document-command-bar button small{position:absolute;top:1px;right:1px;min-width:15px;padding:0 4px;border-radius:999px;color:#4338ca;background:#e9e9ff;font-size:14px;line-height:15px}
...
.teacher-document-command-bar__status{display:inline-flex;align-items:center;gap:5px;color:#687386;font-size:14px;white-space:nowrap}
...
.teacher-document-command-bar__actions :deep(button){min-height:34px;display:flex;align-items:center;justify-content:center;gap:6px;padding:0 10px;border:1px solid transparent;border-radius:9px;color:#526077;background:transparent;font-size:14px;font-weight:750;cursor:pointer}
