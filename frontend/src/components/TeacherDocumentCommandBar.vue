...
<style scoped>
.teacher-document-command-bar-row{position:sticky;z-index:9;top:12px;width:calc(100% - 40px);min-height:44px;display:flex;align-items:center;justify-content:space-between;gap:18px;margin:12px 20px 10px}
...
.teacher-document-command-bar button{min-height:34px;display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:0 9px;border:1px solid transparent;border-radius:9px;color:#526077;background:transparent;font-size:11.5px;font-weight:750;cursor:pointer}
...
.teacher-document-command-bar button small{position:absolute;top:1px;right:1px;min-width:15px;padding:0 4px;border-radius:999px;color:#4338ca;background:#e9e9ff;font-size:8px;line-height:15px}
...
.teacher-document-command-bar__status{display:inline-flex;align-items:center;gap:5px;color:#687386;font-size:11px;white-space:nowrap}
...
.teacher-document-command-bar__actions :deep(button){min-height:34px;display:flex;align-items:center;justify-content:center;gap:6px;padding:0 10px;border:1px solid transparent;border-radius:9px;color:#526077;background:transparent;font-size:11.5px;font-weight:750;cursor:pointer}
...
@media(max-width:1100px){.teacher-document-command-bar-row{width:calc(100% - 24px);justify-content:flex-end;margin-inline:12px}.teacher-document-command-bar__status{display:none}}
</style>
