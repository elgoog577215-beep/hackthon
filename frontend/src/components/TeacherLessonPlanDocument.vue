...
.document-actions{flex:none;display:flex;align-items:center;gap:2px}.document-actions button{min-height:34px;display:flex;align-items:center;justify-content:center;gap:7px;padding:0 10px;border:1px solid transparent;border-radius:7px;color:#526077;background:transparent;font-size:14px;font-weight:750;cursor:pointer}.document-actions button:hover{color:#3730a3;background:#f2f3fa}.document-actions button:focus-visible{outline:2px solid #5b57e8;outline-offset:2px}.document-actions button:disabled{opacity:.5;cursor:not-allowed}.document-actions .primary-action{margin-left:4px;border-color:#d7ddea;color:#3730a3;background:#fff}.document-actions .primary-action:hover{border-color:#c6cbe0;background:#f7f7ff}
.candidate-canvas-notice{display:flex;align-items:center;gap:10px;padding:11px 28px;border-bottom:1px solid #d9ddf5;color:#4338ca;background:#f5f5ff}.candidate-canvas-notice strong{font-size:14px}.lesson-document>:deep(.app-error-notice){margin:12px 28px 0}
.document-body{min-width:0;display:grid;padding:12px 28px 34px}.section-title{display:flex;align-items:center;gap:10px;padding:17px 0 2px}.section-title span{color:#6366f1;font-size:14px;font-weight:850}.section-title h4{margin:0;color:#172033;font-size:16px}.document-section{min-width:0;padding:22px 0;border-bottom:1px solid #e8ecf2}.document-section:last-child{border-bottom:0}.document-section h4{margin:0 0 12px;color:#263147;font-size:16px}.document-section p{margin:0;color:#536176;font-size:15px;line-height:1.75}.document-section ul,.document-section ol{display:grid;gap:7px;margin:0;padding-left:18px;color:#536176;font-size:15px;line-height:1.7}.document-section textarea,.flow-row input,.assignment-contract input{width:100%;box-sizing:border-box;border:1px solid #cbd4e1;border-radius:7px;outline:0;color:#263147;background:#fff;font:inherit;font-size:14px;line-height:1.55}.document-section textarea{min-height:74px;padding:9px 10px;font-size:15px;resize:vertical}.assignment-contract input{min-height:38px;padding:7px 9px}.document-section textarea:focus,.flow-row input:focus,.assignment-contract input:focus{border-color:#5b57e8;box-shadow:0 0 0 3px rgba(91,87,232,.1)}
.lesson-identity{display:grid;grid-template-columns:1fr 1fr;gap:28px}.lesson-identity div{display:grid;gap:6px}.lesson-identity span{color:#7a8699;font-size:14px}.lesson-identity strong{color:#263147;font-size:15px}.objective-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:24px}.objective-grid>div{min-width:0}.objective-grid h5{margin:0 0 9px;color:#4a5568;font-size:14px}.objective-section p{font-size:15px}.focus-grid,.closing-grid{display:grid;grid-template-columns:1fr 1fr;gap:0}.focus-grid>div,.closing-grid>div{min-width:0;padding-right:26px}.focus-grid>div+div,.closing-grid>div+div{padding-right:0;padding-left:26px;border-left:1px solid #e8ecf2}.section-heading{display:flex;align-items:center;justify-content:space-between;gap:16px}.section-heading span{color:#7a8699;font-size:14px}
.teaching-block-list{display:grid;gap:14px}.teaching-block{overflow:hidden;border:1px solid #dde3ec;border-radius:10px;background:#fff}.teaching-block>header{min-height:48px;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:8px 14px;border-bottom:1px solid #e5eaf1;background:#f7f9fc}.teaching-block>header>strong{color:#334155;font-size:15px}.block-duration{display:flex;align-items:center;gap:8px;color:#718096;font-size:14px}.block-duration input{width:64px;height:32px;padding:5px;border:1px solid #cbd4e1;border-radius:7px;text-align:center}.block-duration b{color:#475569;font-size:14px}.block-fields{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0}.block-fields>label{min-width:0;display:grid;align-content:start;gap:7px;padding:14px;border-right:1px solid #e8ecf2;border-bottom:1px solid #e8ecf2}.block-fields>label:nth-child(2n){border-right:0}.block-fields>label.wide{grid-column:1/-1;border-right:0}.block-fields>label>span{color:#64748b;font-size:14px;font-weight:750}.block-fields textarea{min-height:76px;font-size:15px}.block-fields p{font-size:15px;line-height:1.7}.block-fields ul{font-size:15px}.materials-record>h4{margin-bottom:18px}
.lesson-block-summary{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.lesson-block-summary>section{min-width:0;display:grid;align-content:start;gap:8px;padding:15px 16px;border-right:1px solid #e8ecf2;border-bottom:1px solid #e8ecf2}.lesson-block-summary>section:nth-child(2n){border-right:0}.lesson-block-summary>section:nth-child(n+3){border-bottom:0}.lesson-block-summary strong{color:#64748b;font-size:14px}.lesson-block-summary p{font-size:15px;line-height:1.7}.lesson-block-summary ul{gap:5px;font-size:15px;line-height:1.65}
.lesson-theme-nav{display:flex;gap:18px;overflow:auto;padding:4px 0 0;border-bottom:1px solid #e8ecf2}.lesson-theme-nav button{min-height:42px;display:flex;align-items:center;gap:6px;padding:0;border:0;border-bottom:2px solid transparent;color:#667085;background:transparent;font-size:14px;white-space:nowrap;cursor:pointer}.lesson-theme-nav button span{color:#98a2b3;font-size:14px;font-weight:800}.lesson-theme-nav button.active{border-bottom-color:#5b57e8;color:#3730a3;font-weight:750}.lesson-theme{scroll-margin-top:16px;padding:18px 0 10px;border-bottom:2px solid #e4e8ef}.lesson-theme:last-child{border-bottom:0}.lesson-theme-heading{display:flex;align-items:center;justify-content:space-between;gap:18px;padding:8px 0 2px}.lesson-theme-heading>div{display:flex;align-items:baseline;gap:9px}.lesson-theme-heading span{color:#6366f1;font-size:14px;font-weight:800}.lesson-theme-heading h4{margin:0;color:#172033;font-size:17px}.lesson-theme-heading small{color:#667085;font-size:14px}.lesson-time-section .section-heading span{color:#667085}.teaching-block.is-overtime{border-color:#e9b98b}.overtime-warning{display:flex;align-items:center;gap:6px!important;padding:8px 14px;color:#9a4f12!important;background:#fff8ef;font-size:14px!important}.block-contingency{border-top:1px solid #e8ecf2}.block-contingency summary{width:max-content;margin:12px 14px;color:#514dc0;font-size:14px;font-weight:750;cursor:pointer}.block-contingency[open] summary{margin-bottom:0}.assignment-contract{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-top:16px;padding-top:15px;border-top:1px solid #edf0f4}.assignment-contract label{min-width:0;display:grid;align-content:start;gap:6px}.assignment-contract label>span{color:#64748b;font-size:14px;font-weight:750}.assignment-contract p{font-size:14px}
.ai-change-target{position:relative}.is-ai-candidate .ai-change-target{margin-inline:-10px;padding-inline:10px;border-radius:9px;background:linear-gradient(90deg,rgba(238,242,255,.92),rgba(248,250,255,.42))}.ai-change-target::before{position:absolute;top:8px;bottom:8px;left:0;width:2px;border-radius:2px;background:#6366f1;content:""}.ai-change-marker{position:absolute;top:7px;right:9px;padding:3px 6px;border-radius:5px;color:#4338ca;background:#e0e7ff;font-size:14px;font-style:normal;font-weight:800}.flow-section.ai-change-target{padding-inline:10px}.focus-grid>div.ai-change-target,.closing-grid>div.ai-change-target{padding-top:12px;padding-bottom:12px}.focus-grid>div+div.ai-change-target,.closing-grid>div+div.ai-change-target{padding-left:36px}
.flow-table{width:100%;max-width:100%;box-sizing:border-box;overflow:hidden;border:1px solid #dde3ec;border-radius:8px}.flow-row{display:grid;grid-template-columns:72px minmax(120px,.82fr) minmax(170px,1.2fr) minmax(150px,1fr) minmax(150px,1fr);border-top:1px solid #e3e8f0}.flow-row:first-child{border-top:0}.flow-row>div,.flow-head>span{min-width:0;padding:12px 11px;border-left:1px solid #e3e8f0}.flow-row>div:first-child,.flow-head>span:first-child{border-left:0}.flow-head{color:#64748b;background:#f6f8fb;font-size:14px;font-weight:750}.flow-row p{font-size:15px;line-height:1.68}.flow-row ul{gap:5px;padding-left:15px;font-size:15px;line-height:1.65}.duration-cell{color:#475569;font-size:14px;text-align:center}.duration-cell input{height:34px;padding:6px;text-align:center}.phase-cell{display:grid;align-content:start;gap:7px}.phase-cell strong{color:#334155;font-size:14px}.phase-cell p{color:#667386;font-size:15px}.flow-row textarea{min-height:112px;font-size:15px}.flow-empty{padding:28px;color:#7a8699;font-size:14px;text-align:center}
.document-empty{min-height:280px;display:grid;place-items:center;color:#7a8699;font-size:14px}.document-footer{min-height:64px;display:flex;align-items:center;justify-content:flex-end;gap:18px;padding:12px 28px;border-top:1px solid #e8ecf2;background:#fbfcfe}.document-footer button{min-height:38px;display:flex;align-items:center;justify-content:center;gap:7px;padding:0 15px;border:1px solid #514bdc;border-radius:8px;color:#fff;background:#514bdc;font-size:14px;font-weight:750;cursor:pointer}.document-footer button:hover{border-color:#4338ca;background:#4338ca}.document-footer button:disabled{opacity:.45;cursor:not-allowed}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}
