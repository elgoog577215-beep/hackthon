...
/* The empty lesson state uses one clear task surface instead of stacked divider lines. */
.has-lesson-outline .lesson-stage-content{border-color:#dce3ee;background:#f7f8fc;box-shadow:none}
.lesson-section-tabs{gap:4px;padding:8px 18px;border-bottom-color:#e2e7ef;background:#f8f9fc}
.lesson-section-tabs button{min-height:40px;padding:0 12px;border:1px solid transparent;border-radius:8px}
.lesson-section-tabs button:hover{background:#fff}
.lesson-section-tabs button.active{border-color:#d7d9f2;background:#fff;box-shadow:none}
.lesson-generation-step{padding:28px;background:#f7f8fc}
.lesson-generation-entry{gap:20px 28px;padding:24px;border:1px solid #dce3ed;border-radius:14px;background:#fff}
.lesson-generation-copy{gap:6px}
.lesson-generation-copy strong{font-size:20px;letter-spacing:-.018em}
.lesson-generation-copy span{font-size:13px;line-height:1.6}
.lesson-generation-entry>.primary{min-height:42px;padding-inline:17px;transition:transform .16s ease,background-color .16s ease,border-color .16s ease}
.lesson-generation-entry>.primary:hover:not(:disabled){transform:translateY(-1px);border-color:#4338ca;background:#4338ca}
.lesson-focus-field{grid-template-columns:1fr;gap:8px;padding-top:18px;border-top-color:#e5e9f0}
.lesson-focus-field>span{padding-top:0;color:#475569;font-weight:750}
.lesson-focus-field textarea{box-sizing:border-box;min-height:76px;padding:12px 14px;border:1px solid #cbd4e1;border-radius:10px;background:#fbfcfe;transition:border-color .16s ease,background-color .16s ease,box-shadow .16s ease}
.lesson-focus-field textarea:hover{border-color:#aeb9c9;background:#fff}
.lesson-focus-field textarea:focus{border-color:#5b57e8;background:#fff;box-shadow:0 0 0 3px rgba(91,87,232,.1)}
...
.lesson-navigator>button{min-height:32px;padding:0 8px;border:0;border-radius:7px;color:#5552c8;background:transparent;box-shadow:none}
.lesson-navigator>button:hover:not(:disabled){transform:none;border-color:transparent;color:#3730a3;background:#f0f1fa}
.lesson-navigator>button:disabled{border-color:transparent;background:transparent}
