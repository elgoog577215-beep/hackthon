...
function phaseLabel(phase: string | undefined, status: Task['status'], taskType?: string) {
  ...
  const labels: Record<string, string> = {
    ...
    outline_auto_improvement: t('courseWorkbench.autoImprovement.outline', '正在自动优化大纲并复审'),
    lesson_plan_auto_improvement: t('courseWorkbench.autoImprovement.lesson', '正在自动优化教案并复审'),
    lesson_script_auto_improvement: t('courseWorkbench.autoImprovement.script', '正在自动优化讲义并复审'),
...
.task-kind-chip { display:inline-flex; align-items:center; color:var(--lz-text-muted); font-size:12px; font-weight:700; }
.status-chip { display:inline-flex; min-height:24px; align-items:center; padding:0 8px; border-radius:5px; color:var(--lz-brand-strong); background:var(--lz-brand-soft); font-size:12px; font-weight:700; }.status-chip[data-status="completed"] { color:var(--lz-success); background:var(--lz-success-soft); }.status-chip[data-status="error"],.status-chip[data-status="conflict"],.status-chip[data-status="completed_with_warnings"] { color:var(--lz-warning); background:var(--lz-warning-soft); }
.task-summary h3 { margin:8px 0 4px; color:var(--lz-text-strong); font-size:19px; }.task-summary p { margin:0; color:var(--lz-text-secondary); font-size:12px; line-height:1.5; }
...
.task-summary dl { margin:0; display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:14px; }.task-summary dl div { min-width:0; }.task-summary dt { color:var(--lz-text-muted); font-size:12px; }.task-summary dd { margin:4px 0 0; overflow:hidden; color:var(--lz-text); font-size:13px; font-weight:650; text-overflow:ellipsis; white-space:nowrap; }
...
.web-search-summary__status { font-size:12px; padding:2px 8px; border-radius:999px; color:var(--lz-brand-strong); background:var(--lz-brand-soft); }
...
.web-search-summary__hint,.web-search-summary__empty { margin:0; font-size:12px; color:var(--lz-text-muted); }
.web-search-summary__queries { display:grid; gap:5px; }
.web-search-summary__queries dt { font-size:12px; color:var(--lz-text-muted); }
.web-search-summary__queries dd { margin:0; display:flex; flex-wrap:wrap; gap:6px; }
.web-search-summary__queries dd span { font-size:12px; padding:2px 8px; border-radius:6px; color:var(--lz-text); background:var(--lz-surface-muted,#f1f5f9); }
...
.web-search-summary__exclude { flex:0 0 auto; padding:1px 8px; border:1px solid var(--lz-border); border-radius:999px; background:transparent; color:var(--lz-text-muted); font-size:12px; line-height:1.7; cursor:pointer; }
...
.web-search-summary__pending { margin:0; font-size:12px; color:#92400e; }
.web-search-summary__sources a { font-size:12px; color:var(--lz-brand-strong); overflow-wrap:anywhere; }
.web-search-summary__sources small,.web-search-summary__rejected small { font-size:12px; color:var(--lz-text-muted); }
.web-search-summary__rejected summary { font-size:12px; color:var(--lz-text-muted); cursor:pointer; }
.web-search-summary__rejected ul { margin:8px 0 0; padding:0; list-style:none; display:grid; gap:6px; }
.web-search-summary__rejected li { display:grid; gap:2px; font-size:12px; overflow-wrap:anywhere; word-break:break-all; min-width:0; }
...
.task-observability__stage strong { max-width:100%; overflow:hidden; color:var(--lz-text-secondary); font-size:12px; text-overflow:ellipsis; white-space:nowrap; }
.task-observability__stage small { color:var(--lz-text-muted); font-size:12px; }
...
.knowledge-scope { margin-bottom:16px; padding:14px; border:1px solid rgba(14,116,144,.16); border-radius:10px; background:rgba(236,254,255,.58); }.knowledge-scope > header strong,.knowledge-scope > header span { display:block; }.knowledge-scope > header strong { color:var(--lz-text-strong); font-size:12px; }.knowledge-scope > header span { margin-top:4px; color:var(--lz-text-secondary); font-size:12px; line-height:1.5; }.knowledge-scope > div { margin-top:10px; display:grid; gap:7px; }.knowledge-scope article { display:grid; grid-template-columns:34px minmax(0,1fr); gap:8px; padding-top:8px; border-top:1px solid rgba(14,116,144,.12); }.knowledge-scope article > span { color:#0e7490; font-family:ui-monospace,monospace; font-size:12px; font-weight:800; }.knowledge-scope article strong { display:block; color:var(--lz-text-strong); font-size:12px; }.knowledge-scope article p { margin:3px 0 0; color:var(--lz-text-secondary); font-size:12px; line-height:1.45; }.knowledge-scope article small { display:block; margin-top:4px; color:#0e7490; font-size:12px; line-height:1.4; }
.knowledge-relations { margin-top:16px; }.knowledge-relations > strong { color:var(--lz-text-strong); font-size:12px; }.knowledge-relations ul { margin:8px 0 0; padding:0; display:grid; gap:6px; list-style:none; }.knowledge-relations li { display:grid; grid-template-columns:minmax(0,1fr) 14px minmax(0,1fr); align-items:center; gap:5px; padding:8px 9px; border:1px solid var(--lz-border); border-radius:7px; color:var(--lz-text-secondary); background:var(--lz-surface-muted); font-size:12px; }.knowledge-relations li b { color:var(--lz-brand-strong); text-align:center; }.knowledge-relations li small { grid-column:1 / -1; color:var(--lz-text-muted); line-height:1.4; }
.composition-review { margin-bottom:16px; padding:14px; border:1px solid rgba(99,102,241,.18); border-radius:10px; background:var(--lz-brand-soft); }.composition-review__heading > span,.composition-review__rhythm > span { display:block; margin-bottom:3px; color:var(--lz-text-muted); font-size:12px; }.composition-review__heading strong { color:var(--lz-text-strong); font-size:14px; }.composition-review__heading p,.composition-review__rhythm p { margin:4px 0 0; color:var(--lz-text-secondary); font-size:12px; line-height:1.5; }.composition-review__rhythm { margin-top:10px; padding-top:10px; border-top:1px solid rgba(99,102,241,.12); }.role-distribution { display:flex; flex-wrap:wrap; gap:6px; margin:11px 0 0; }.role-distribution div { display:inline-flex; align-items:center; gap:5px; padding:4px 7px; border:1px solid rgba(99,102,241,.14); border-radius:999px; color:var(--lz-text-secondary); background:#fff; }.role-distribution dt,.role-distribution dd { margin:0; font-size:12px; }.role-distribution dd { color:var(--lz-brand-strong); font-weight:800; }
.review-cards { border-top:1px solid var(--lz-border); }.review-cards article { display:grid; grid-template-columns:30px minmax(0,1fr); gap:10px; padding:12px 0; border-bottom:1px solid rgba(226,232,240,.75); }.review-cards article > span { color:var(--lz-text-muted); font-family:ui-monospace,monospace; font-size:12px; }.review-cards strong { display:block; color:var(--lz-text-strong); font-size:12px; }.review-cards p { margin:4px 0 0; color:var(--lz-text-secondary); font-size:12px; line-height:1.5; }.review-cards small { display:block; margin-top:6px; color:var(--lz-brand-strong); font-size:12px; line-height:1.45; }.review-cards--compact article { padding:9px 0; }
.module-sequence { display:flex; flex-wrap:wrap; gap:6px; margin-top:10px; }.module-sequence__item { position:relative; min-width:130px; max-width:220px; display:grid; gap:2px; padding:7px 8px; border:1px solid var(--lz-border); border-radius:7px; color:var(--lz-text-secondary); background:var(--lz-surface-muted); }.module-sequence__item[data-added="true"] { border-color:rgba(99,102,241,.28); background:var(--lz-brand-soft); }.module-sequence__item[data-source="difficulty_level"] { border-color:rgba(217,119,6,.28); background:var(--lz-warning-soft); }.module-sequence__item b { overflow:hidden; color:var(--lz-text-strong); font-size:12px; text-overflow:ellipsis; white-space:nowrap; }.module-sequence__item em { color:var(--lz-text-muted); font-size:12px; font-style:normal; line-height:1.35; }.module-sequence__item i { color:var(--lz-brand-strong); font-size:12px; font-style:normal; font-weight:700; }.module-sequence__item[data-source="difficulty_level"] i { color:var(--lz-warning); }
...
.content-evidence { margin:10px 0; display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:8px; }.content-evidence > div { padding:10px; border:1px solid var(--lz-border); border-radius:8px; background:var(--lz-surface-muted); }.content-evidence span,.content-evidence strong { display:block; }.content-evidence span { color:var(--lz-text-muted); font-size:12px; }.content-evidence strong { margin-top:4px; color:var(--lz-text-strong); font-size:13px; }.asset-counts { display:flex; flex-wrap:wrap; gap:5px; margin-bottom:10px; }.asset-counts span { padding:4px 7px; border:1px solid rgba(99,102,241,.14); border-radius:999px; color:var(--lz-brand-strong); background:var(--lz-brand-soft); font-size:12px; font-weight:650; }
.question-review { margin:14px 0; padding:14px; border:1px solid rgba(14,116,144,.16); border-radius:10px; background:rgba(236,254,255,.42); }.question-review>header { display:flex; justify-content:space-between; align-items:flex-start; gap:14px; }.question-review>header strong { color:var(--lz-text-strong); font-size:12px; }.question-review>header p { margin:4px 0 0; max-width:460px; color:var(--lz-text-secondary); font-size:12px; line-height:1.5; }.question-review>header>span { flex:0 0 auto; padding:5px 8px; border-radius:999px; color:#047857; background:#ecfdf5; font-size:12px; font-weight:800; }.question-review>header>span[data-blocked="true"] { color:var(--lz-warning); background:var(--lz-warning-soft); }.question-review__list { margin-top:12px; display:grid; gap:8px; }.question-review__list>article { display:grid; grid-template-columns:28px minmax(0,1fr); gap:9px; padding:10px; border:1px solid rgba(14,116,144,.12); border-radius:8px; background:#fff; }.question-review__list>article[data-status="blocked"] { border-color:rgba(217,119,6,.28); }.question-review__index { color:#0e7490; font-family:ui-monospace,monospace; font-size:12px; font-weight:800; }.question-review__meta { display:flex; justify-content:space-between; gap:8px; margin-bottom:5px; color:var(--lz-text-muted); font-size:12px; }.question-review__meta b { color:#0e7490; }.question-review__list article>div>strong { display:block; color:var(--lz-text-strong); font-size:12px; line-height:1.5; }.question-review dl { display:grid; grid-template-columns:1fr 1fr; gap:10px; margin:9px 0; }.question-review dt { color:var(--lz-text-muted); font-size:12px; }.question-review dd { margin:3px 0 0; color:var(--lz-text-secondary); font-size:12px; line-height:1.45; }.question-review__targets { display:flex; flex-wrap:wrap; gap:4px; }.question-review__targets span { padding:3px 6px; border-radius:999px; color:#0e7490; background:#ecfeff; font-size:12px; }.question-review__targets span[data-kind="mistake"] { color:#c2410c; background:#fff7ed; }.question-review ul { margin:8px 0 0; padding-left:16px; color:var(--lz-warning); font-size:12px; line-height:1.5; }
