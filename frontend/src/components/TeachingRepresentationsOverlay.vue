...
.representations-shell > header { display:grid; grid-template-columns:minmax(180px,1fr) auto minmax(72px,1fr); align-items:center; gap:12px; padding:0 14px 0 20px; border-bottom:1px solid var(--lz-border); }
