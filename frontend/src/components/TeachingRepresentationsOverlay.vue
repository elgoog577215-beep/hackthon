    ...
    <div class="representations-shell resource-workspace-shell">
      <header class="resource-workspace-header">
        ...
        <div class="representations-actions">
          <button type="button" class="representations-refresh" :disabled="store.building" :title="t('teachingRepresentations.rebuild', '同步课程最新内容')" :aria-label="t('teachingRepresentations.rebuild', '同步课程最新内容')" @click="store.build(courseId)">
