<template>
  <section
    ...
    :data-state="arrangement.source_state === 'current' ? 'ready' : 'stale'"
  >
    <header class="arrangement-toolbar">
      <div class="arrangement-context">
        <span class="arrangement-state" role="status">
          <Check v-if="arrangement.source_state === 'current'" :size="17" />
