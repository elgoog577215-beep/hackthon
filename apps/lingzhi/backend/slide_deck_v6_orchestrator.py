...
class SlideDeckV6Orchestrator:
    ...
    async def build(
        ...
        *,
        ...
        execution_identity = {**tool_identity(), "manuscript_quality": MANUSCRIPT_QUALITY_VERSION} if three_stage else None
        try:
        ...
        try:
            ...
            if not manuscript_quality_passed(ppt_manuscript.model_dump(mode="json")):
