...
async def _run_with_batch_generation_slot(
    ...
    """Limit model work to four concurrent lessons from batch requests."""
...
def _ppt_manuscript_state_payload(
    ...
    *,
    ...
    layouts = []
    if manuscript_payload and manuscript_payload.get("teaching_content_contract_version") == "page_teaching_v2":
