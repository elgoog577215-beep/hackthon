...
.objective-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:24px}.objective-grid>div{min-width:0}.objective-grid h5{margin:0 0 9px;color:#4a5568;font-size:15px}.objective-grid.is-ai-reviewing{grid-template-columns:minmax(0,1fr);gap:24px}.objective-grid.is-ai-reviewing h5{padding-right:74px}.objective-grid.is-ai-reviewing :is(li,p){overflow-wrap:anywhere}.objective-section p{font-size:16px}.focus-grid,.closing-grid{display:grid;grid-template-columns:1fr 1fr;gap:0}.focus-grid>div,.closing-grid>div{min-width:0;padding-right:26px}.focus-grid>div+div,.closing-grid>div+div{padding-right:0;padding-left:26px;border-left:1px solid #e8ecf2}.section-heading{display:flex;align-items:center;justify-content:space-between;gap:16px}.section-heading span{color:#7a8699;font-size:15px}
...
.ai-change-target{position:relative}.is-ai-candidate .ai-change-target{margin-inline:-10px;padding-inline:10px;border-radius:9px;background:linear-gradient(90deg,rgba(238,242,255,.92),rgba(248,250,255,.42))}.is-ai-candidate .objective-grid.is-ai-reviewing>.ai-change-target{margin-inline:0;padding:0;border-radius:0;background:transparent}.objective-grid.is-ai-reviewing>.ai-change-target::before{display:none}.ai-change-target::before{position:absolute;top:8px;bottom:8px;left:0;width:2px;border-radius:2px;background:#6366f1;content:""}.ai-change-marker{position:absolute;top:0;right:0;padding:2px 6px;border-radius:999px;color:#4338ca;background:#e0e7ff;font-size:11px;font-style:normal;font-weight:800;line-height:1.5}.flow-section.ai-change-target{padding-inline:10px}.focus-grid>div.ai-change-target,.closing-grid>div.ai-change-target{padding-top:12px;padding-bottom:12px}.focus-grid>div+div.ai-change-target,.closing-grid>div+div.ai-change-target{padding-left:36px}
