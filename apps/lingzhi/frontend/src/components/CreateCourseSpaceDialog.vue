<template>
  <CourseDialogShell v-if="modelValue" :title="t('courseSpaceCreate.title')" :busy="busy" @close="close">
      <div class="course-space-dialog course-space-dialog-body">
...
import CourseDialogShell from './CourseDialogShell.vue'
...
<style scoped>
.course-space-dialog.course-space-dialog-body{display:contents}
