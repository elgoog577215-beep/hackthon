...
>
> 当前状态：[`docs/product-status.md`](../product-status.md)
>
...
本文只维护课程知识库的稳定目标设计，不维护协议版本、存量扫描、已完成项、当前缺口或下一步。实现状态统一查看[产品状态板](../product-status.md)，具体任务与验收统一查看 [`build-structured-adaptive-course-ai`](../../openspec/changes/build-structured-adaptive-course-ai/)。

2026-07-19 的首次纵向实现对账仍可通过 Git 历史和项目决策追溯，不再留在当前设计正文中影响后续判断。
